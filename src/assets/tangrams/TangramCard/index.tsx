...
const TangramCard: React.FC<TangramCardProps> = ({ className = "" }) => {
  ...
  useEffect(() => {
    ...
    visibilityFunctions.forEach((visibilityFunction) =>
  ...
  return (
    <div className={`${styles.container} ${className}`}>
      ...
      >
        ...
        <g
          className={`${styles.styles} ${isPathThreeHidden ? styles.hide : ""}`}
        >
        ...
        <g
          className={`${styles.styles} ${isPathFourHidden ? styles.hide : ""}`}
        >
        ...
        <g
          className={`${styles.styles} ${isPathFiveHidden ? styles.hide : ""}`}
        >
        ...
        <g
          className={`${styles.styles} ${isPathSevenHidden ? styles.hide : ""}`}
        >
        ...
        <g
          className={`${styles.styles} ${isPathEightHidden ? styles.hide : ""}`}
        >
        ...
        <g
          className={`${styles.styles} ${isPathNineHidden ? styles.hide : ""}`}
        >
        ...
        <g
          className={`${styles.styles} ${
            isPathElevenHidden ? styles.hide : ""
          }`}
        >
        ...
        <g
          className={`${styles.styles} ${
            isPathTwelveHidden ? styles.hide : ""
          }`}
        >
        ...
        <g
          className={`${styles.styles} ${
            isPathThirteenHidden ? styles.hide : ""
          }`}
        >
        ...
        <g
          className={`${styles.styles} ${
            isPathFourteenHidden ? styles.hide : ""
          }`}
        >
        ...
        <g
          className={`${styles.styles} ${
            isPathFifteenHidden ? styles.hide : ""
          }`}
        >
        ...
        <g
          className={`${styles.styles} ${
            isPathSixteenHidden ? styles.hide : ""
          }`}
        >
